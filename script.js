...
(() => {
  ...
  document.addEventListener('keydown', (e) => {
    // Ignora navegação se um painel estiver aberto
    if (document.querySelector('.expand-panel.open')) return;
  ...
  // ───────── EXPAND PANELS (BOTÕES INTERATIVOS) ─────────
  ...
  function openPanel(name) {
    ...
    const btn = document.querySelector(`.expand-btn[data-panel="${name}"]`);
